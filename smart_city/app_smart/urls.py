...
from . import views
from app_smart.api.viewsets import ContadorDataViewSet, CreateUserAPIViewSet, SensorViewSet, SensorFilterView, TemperaturaDataViewSet
from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView
from rest_framework.routers import DefaultRouter
from app_smart.api.filters import ContadorFilterView, TemperaturaFilterView
